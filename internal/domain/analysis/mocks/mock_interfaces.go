...
// Source: github.com/squeakycheese75/tick/internal/domain/analysis (interfaces: PricingSvc)
//
// Generated by this command:
//
//	mockgen -destination=./mocks/mock_interfaces.go -package=mocks . PricingSvc
//
